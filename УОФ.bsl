...
//  ПравоеЗначение - Любой тип - правое значение сравнения
//
Процедура ДобавитьЭлементОтбора(ЭлементОформления, ИмяПоля, ВидСравненияДляПоля, ПравоеЗначение) Экспорт 
...
//  ИмяТаблицы - Строка - Имя таблицы формы 
//
Процедура ДобавитьВсеПоляТаблицыУсловногоОформления(ЭлементОформления, ЭлементыФормы, ИмяТаблицы) Экспорт
	
	РеквизитыТаблицы = ЭлементыФормы.ПолучитьРеквизиты(ИмяТаблицы);
